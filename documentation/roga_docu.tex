...
%%% author(s)
\author{Torben Miller (Matrikelnummer) \and
Fabian Biedlingmaier (Matrikelnummer)        \and
...
\section{Aufgabenstellung} Nico
\subsection{Maps & Robo} Nico
\subsection{Technischer Stand minmax Kraftbasiert etc. A Star} Nico
\subsection{Zielsetzung} Nico

\section{Konzept}
\subsection{State machine?} Torben
\subsection{Homing} Torben
\subsection{Collison Avoidance} Fabian

\section{Dikussion und Ausblick} Alle
\subsection{Videos} Alle
\subsection{Szenarien} Alle
