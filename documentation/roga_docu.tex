...
In diesem Projekt soll ein kraftbasierter Ansatz implementiert werden. Anschließend sollen die Parameter so angepasst werden das sie möglichst optimal im Wettkampf gegen die anderen Ansätze der anderen Teilnehmer des Projektes abschneiden.
\clearpage
